...
var Fill = function () {
  ...
  _createClass(Fill, [{
    ...
    value: function fillPath(elSeries, opts) {
      ...
      var defaultColor = _Utils2.default.hexToRgba(fillColors[this.seriesIndex], fillOpacity);
...
var Series = function () {
  ...
  _createClass(Series, [{
    ...
    value: function getSeriesByName(seriesName) {
      return this.w.globals.dom.baseEl.querySelector('.apexcharts-series.' + seriesName.replace(/ /g, '-'));
    }
  }, {
...
var _Formatters = __webpack_require__(30);
...
var _Options = __webpack_require__(51);
    ...
    value: function drawArcs(sectorAngleArr, series) {
      ...
      for (var i = 0; i < sectorAngleArr.length; i++) {
        ...
        var elPieArc = graphics.group({
          class: 'apexcharts-series apexcharts-pie-series ' + w.globals.seriesNames[i].replace(/ /g, '-'),
...
var _Dimensions = __webpack_require__(46);
...
var _CoreUtils = __webpack_require__(75);
...
var _TitleSubtitle = __webpack_require__(138);
...
var ApexCharts = function () {
  ...
  _createClass(ApexCharts, [{
    ...
    value: function getChartArea() {
      ...
      var el = paper.select('.apexcharts-inner');
...
var _Bar2 = __webpack_require__(44);
      ...
      for (var i = series.length - 1; i >= 0; i--) {
        ...
        for (var j = 0; j < series[i].length; j++) {
          ...
          if (w.globals.dataChanged) {
            ...
            var colorFrom = w.globals.previousPaths[i][j].color;
    ...
    value: function drawArcs(opts) {
      ...
      for (var i = reverseLoop ? opts.series.length - 1 : 0; reverseLoop ? i >= 0 : i < opts.series.length; reverseLoop ? i-- : i++) {
        var elRadialBarArc = graphics.group({
          class: 'apexcharts-series apexcharts-radial-series ' + w.globals.seriesNames[i].replace(/ /g, '-')
        });
...
var Core = function () {
  ...
  _createClass(Core, [{
    ...
    value: function getCalculatedRatios() {
      ...
      // multiple y axis
      for (var _i3 = 0; _i3 < gl.yRange.length; _i3++) {
        yRatio.push(gl.yRange[_i3] / gl.gridHeight);
      }
      ...
      if (gl.minY !== Number.MIN_VALUE && Math.abs(gl.minY) !== 0) {
        ...
        if (gl.isMultipleYAxis) {
          for (var _i4 = 0; _i4 < yRatio.length; _i4++) {
            baseLineY.push(-gl.minYArr[_i4] / yRatio[_i4]);
          }
        } else {
    ...
    value: function checkComboCharts() {
      var w = this.w;
      var cnf = w.config;

      cnf.series.map(function (series) {
    ...
    value: function drawGrid() {
      ...
      var grid = new _Grid2.default(this.ctx);
      var xAxis = new _XAxis2.default(this.ctx);
  ...
  _createClass(Range, [{
    ...
    value: function niceScale(yMin, yMax) {
      ...
      if (yMin === Number.MIN_VALUE && yMax === 0 || !_Utils2.default.isNumber(yMin) && !_Utils2.default.isNumber(yMax)) {
        ...
        yMax = 1;
        ticks = 1;
        var justRange = this.justRange(yMin, yMax, ticks);
        return justRange;
      }
...
var Responsive = function () {
  ...
  _createClass(Responsive, [{
    ...
    value: function checkResponsiveConfig() {
      var w = this.w;
      var cnf = w.config;
