                        ...
                        <div class="section-3-sec <?php if($min==$product['id']): ?> featured <?php endif; ?>" id="<?php echo e($product['id']); ?>">
                            <div class="row section-3">
                                <div class="col-md-12 sec-3-head">
                                  <form action="<?php echo e(url('bevestiging')); ?>" method="get">
                                        ...
                                        <input type="hidden" name="type" id="get_type" value="<?php echo e($parameters['values']['customer_group']); ?>">
                                        <input type="hidden" name="postalcode" id="get_postalcode" value="<?php echo e($parameters['values']['postal_code']); ?>">
                            ...
                            <div class="row part">
                                <div class="col-md-3 col-sm-6 part-1">
                                    <img src="<?php echo e($supplier['logo']); ?>" alt="Tariefchecker">
                               ...
                               ?>
                                ...
                                <?php if($prc>0): ?>
                                    <ul <?php if(Session::get('currentValue')): ?>    <?php else: ?> style="display:none;" <?php endif; ?> class="year_savings years">
                                        ...
                                        <!--<?php $prc=number_format($price['totals']['year']['excl_promo']/100,2,',', '.');  $sp_price=preg_split("/,/",$prc)  ?> <?php echo e($sp_price[0]); ?></b><sup>,<?php echo e($sp_price[1]); ?></sup>-->
                                ...
                                <?php endif; ?>
                             <div class="col-md-2 col-sm-6 part-4 <?php if(Session::get('currentValue')): ?> left-active   <?php else: ?>  <?php endif; ?>" >
                                     <ul>
                                        ...
                                        <!--<li>-->
                                        <!--    <p class="<?php if($per1!=0): ?> red <?php endif; ?> euro years ">aaa<b>&#8364; </i><?php $prc=number_format($price['breakdown']['electricity']['taxes']['tax']/100+$price['breakdown']['electricity']['distribution_and_transport']['transport']/100+$price['breakdown']['electricity']['distribution_and_transport']['distribution']/100+$price['breakdown']['electricity']['energy_cost']['certificates']/100+$price['breakdown']['electricity']['energy_cost']['single']/100+$price['breakdown']['electricity']['energy_cost']['day']/100+$price['breakdown']['electricity']['energy_cost']['night']/100+$price['breakdown']['electricity']['energy_cost']['excl_night']/100+$price['breakdown']['electricity']['energy_cost']['fixed_fee']/100,2,',', '.');  $sp_price=preg_split("/,/",$prc)  ?> <?php echo e($sp_price[0]); ?></b><sup>,<?php echo e($sp_price[1]); ?></sup></p>-->
                                        <!--</li>-->
                                        <li>
                                        ...
                                        <?php if((Session::get('promo')=='true' && $parameters['values']['promo_discount']['promo']=='promo') || (Session::get('domi')=='true' && $parameters['values']['promo_discount']['discount_serviceLevelPayment']=='domi') || (Session::get('email')=='true' && $parameters['values']['promo_discount']['discount_serviceLevelInvoicing']=='email')): ?>
                                         ...
                                         <li>
                                            <p class="<?php if($per1!=0): ?> red <?php endif; ?> euro years "><b>&#8364; </i><?php $prc=number_format($discAmount,2,',', '.'); $sp_price=preg_split("/,/",$prc)  ?> <?php echo e($sp_price[0]); ?></b><sup>,<?php echo e($sp_price[1]); ?></sup></p> <p class="euro month" style="display:none;"><b>&#8364; </i><?php $prc=number_format(($discAmount/12),2,',', '.'); $sp_price=preg_split("/,/",$prc)  ?> <?php echo e($sp_price[0]); ?></b><sup>,<?php echo e($sp_price[1]); ?></sup></p>
                                        </li>
                                        <li>
                                            <?php if($per1!=0): ?> <p class="strike years"> <strike> &#8364; </i><?php echo e(number_format($price['totals']['year']['excl_promo']/100,2,',', '.')); ?></strike> <span class="disc"><?php $per=100-(($discAmount/($price['totals']['year']['excl_promo']/100))*100) ?> -<?php echo e(number_format($per,2,',', '.')); ?>%</span></p><p class="strike month" style="display:none;"> <strike> &#8364;</i><?php echo e(number_format($price['totals']['month']['excl_promo']/100,2,',', '.')); ?></strike> <span class="disc"><?php $per1=100-((($discAmount/12)/($price['totals']['month']['excl_promo']/100))*100) ?> -<?php echo e(number_format($per1, 2,',', '.')); ?>%</span></p><?php endif; ?>

                                        </li>
                                        <?php else: ?>
                                         <?php $per1=100-(round((round($discAmount)/12)*100/round($price['totals']['month']['excl_promo']))*100) ?>
                                         <li>
                                            <p class=" euro years "><b>&#8364; </i><?php $prc=number_format($price['totals']['year']['excl_promo']/100,2,',', '.'); $sp_price=preg_split("/,/",$prc)  ?> <?php echo e($sp_price[0]); ?></b><sup>,<?php echo e($sp_price[1]); ?></sup></p> <p class=" euro month" style="display:none;"><b>&#8364; </i><?php $prc=number_format($discAmount,2,',', '.'); $sp_price=preg_split("/,/",$prc)  ?> <?php echo e($sp_price[0]); ?></b><sup>,<?php echo e($sp_price[1]); ?></sup></p>
                                        </li>
                                        ...
                                        <?php endif; ?>
                                         ...
                                         <?php if($p_type=='pack' && $packType=='gas' ): ?>
                                           <?php $per1=100-((($discAmount/12)/($price['totals']['month']['excl_promo']/100))*100) ?>
                                        <li>
                                            <p class="<?php if($per1!=0): ?> red <?php endif; ?> euro years "><b>&#8364; </i><?php $prc=number_format(($price['breakdown']['gas']['energy_cost']['fixed_fee']+$price['breakdown']['gas']['energy_cost']['usage']+$price['breakdown']['gas']['distribution_and_transport']['distribution']+$price['breakdown']['gas']['distribution_and_transport']['transport']+$price['breakdown']['gas']['taxes']['tax'])/100,2,',', '.'); $sp_price=preg_split("/,/",$prc)  ?> <?php echo e($sp_price[0]); ?></b><sup>,<?php echo e($sp_price[1]); ?></sup></p> <p class="<?php if($per1!=0): ?> red <?php endif; ?> euro month " style="display:none;"><b>&#8364; </i><?php $prc=number_format(($price['breakdown']['gas']['energy_cost']['fixed_fee']+$price['breakdown']['gas']['energy_cost']['usage']+$price['breakdown']['gas']['distribution_and_transport']['distribution']+$price['breakdown']['gas']['distribution_and_transport']['transport']+$price['breakdown']['gas']['taxes']['tax'])/100,2,',', '.'); $sp_price=preg_split("/,/",$prc)  ?> <?php echo e($sp_price[0]); ?></b><sup>,<?php echo e($sp_price[1]); ?></sup></p>
                                        </li>
                                        <li>
                                        ...
                                        <?php else: ?>
                                         <?php $per1=100-(round((round($discAmount)/12)*100/round($price['totals']['month']['excl_promo']))*100) ?>
                                         <li>
                                            <p class=" euro years "><b>&#8364; </i><?php $prc=number_format($price['totals']['year']['excl_promo']/100,2,',', '.');  $sp_price=preg_split("/,/",$prc)  ?> <?php echo e($sp_price[0]); ?></b><sup>,<?php echo e($sp_price[1]); ?></sup</p><p class=" euro month"  style="display:none;"><b>&#8364;</i><?php $prc=number_format(($discAmount/12),2,',', '.');  $sp_price=preg_split("/,/",$prc)  ?> <?php echo e($sp_price[0]); ?></b><sup>,<?php echo e($sp_price[1]); ?></sup></p>
                                        </li>
                                        ...
                                        <!--<li>-->
                                        <!--    <p class="<?php if($per1!=0): ?> red <?php endif; ?> euro years "><b>&#8364; </i><?php $prc=number_format($price['totals']['year']['incl_promo']/100,2,',', '.');  $sp_price=preg_split("/,/",$prc)  ?> <?php echo e($sp_price[0]); ?></b><sup>,<?php echo e($sp_price[1]); ?></sup></p><p class="<?php if($per1!=0): ?> red <?php endif; ?> euro month"  style="display:none;"><b>&#8364;</i><?php $prc=number_format($price['totals']['month']['incl_promo']/100,2,',', '.');  $sp_price=preg_split("/,/",$prc)  ?> <?php echo e($sp_price[0]); ?></b><sup>,<?php echo e($sp_price[1]); ?></sup></p>-->
                                        <!--</li>-->
                                ...
                                <div class="col-md-2 col-sm-6 part-5">
                                        ...
                                        <input type="hidden" name="type"  value="<?php echo e($parameters['values']['customer_group']); ?>">
                                        <input type="hidden" name="postalcode"  value="<?php echo e($parameters['values']['postal_code']); ?>">
                                        <input type="hidden" name="elect_day" id="" <?php if(isset($usage_elec_day)): ?> value="<?php echo e($usage_elec_day); ?>" <?php endif; ?>>
                                        <input type="hidden" name="elect_night" <?php if(isset($usage_elec_night)): ?> value="<?php echo e($usage_elec_night); ?>" <?php endif; ?> >
                                        <input type="hidden" name="gas_cons" <?php if(isset($usage_gas)): ?> value="<?php echo e($usage_gas); ?>" <?php endif; ?>>
                                        <?php if($parameters['values']['comparison_type']=='elecrticity'): ?>
                                        <input type="hidden" name="sub_url"  value="<?php echo e($product['subscribe_url']); ?>">
                                        <input type="hidden" name="pro_type"  value="electricity">
                                        <?php elseif($parameters['values']['comparison_type']=='gas'): ?>
                                        <input type="hidden" name="sub_url"  value="<?php echo e($product['subscribe_url']); ?>">
                                        ...
                                        <?php endif; ?>
                                         <input type="hidden" name="pr_type" id="pr_type" value="dual">
                                         <input type="hidden" name="pro_type"  value="<?php echo e($product['type']); ?>">
                                     
                                        <button id="choose<?php echo e($product['id']); ?>" data-id="<?php echo e($product['id']); ?>" type="submit" class="choose" rel="tooltip" title="<?php echo app('translator')->getFromJson('home.To_Request'); ?>"><?php if(Session::get('selected_product')==$product['id']): ?> <i class='fa fa-check' aria-hidden='true'></i><?php echo app('translator')->getFromJson('home.check_select'); ?> <?php else: ?> <?php echo app('translator')->getFromJson('home.To_Request'); ?> <?php endif; ?></button>
                                        <?php
...
<!--<button id="getchoose<?php echo e($product['id']); ?>" data-id="<?php echo e($product['id']); ?>" type="submit" class="choose getchoose sel<?php echo e($packType); ?>" rel="tooltip" data-supplier="<?php echo e($supplier['name']); ?>" data-product="<?php echo e($product['name']); ?>" data-type='<?php echo e($packType); ?>' title="<?php echo app('translator')->getFromJson('home.choose_Kiezen'); ?>"><?php echo app('translator')->getFromJson('home.Choose'); ?></button>-->
<!--<p class="heart" style="color:green;"><i class="fa fa-heart"></i><?php echo e($product['popularity_score']); ?>% <?php echo app('translator')->getFromJson('home.Choose'); ?></p>-->
                            ...
                            <div class="row more-content more-contenta<?php echo e($product['id']); ?>">
                                <div class="col-md-12 more-tab">
                                    <div class="tab">
                                        ...
                                        <button class="tablinks" onclick="openCity(event, 'discount<?php echo e($product['id']); ?>')"><?php echo app('translator')->getFromJson('home.Discounts'); ?></button>
                                                ...
                                                <div class="row energy-sec mt-1">
                                                    <div class="col-md-8 col-8 col-lg-8 energy ">
                                                        <ul>
                                                            ...
                                                            <!--<li>beperkte dienstverlening</li>-->
                                                    ...
                                                    <div class="col-md-4 col-4 col-lg-4 energy-price red-color text-right">
                                                        ...
                                                        <?php if((Session::get('promo')=='true' && $parameters['values']['promo_discount']['promo']=='promo') || (Session::get('domi')=='true' && $parameters['values']['promo_discount']['discount_serviceLevelPayment']=='domi') || (Session::get('email')=='true' && $parameters['values']['promo_discount']['discount_serviceLevelInvoicing']=='email')): ?>
                                                            ...
                                                            <!--<li class="red-text">- &#8364; <?php echo e(number_format($sl_disc,2,',', '.')); ?></li>-->
                                                            <!--<li class="red-text">- &#8364; <?php echo e(number_format($loyalty_disc,2,',', '.')); ?></li><br>-->
                                                            <?php else: ?>
                                            ...
                                            <div <?php if($product['type']=='pack'): ?> class="col-md-4 col-lg-4 col-sm-12 total-sec" <?php else: ?> class="col-md-6 col-lg-6 col-sm-12 total-sec" <?php endif; ?> >
                                                ...
                                                <div class="total-bg mt-4">
                                                    ...
                                                    <div class="total_sec_last">
                                                            ...
                                                            <div class="right_total red-text">
                                                              &#8364; -<?php echo e(number_format(($promo_disc),2,',', '.')); ?>
                                                            ...
                                                            <div class="right_total">
                                                              ...
                                                              &#8364;  <?php echo e(number_format(($price['totals']['year']['excl_promo']/100)-($eleD+$gasD+$all_discTotal),2,',', '.')); ?>
                                                   ...
                                                   <!--  <div class="row total-sec-1">
                                                        ...
                                                        <div class="col-md-8 col-8 col-lg-8 energy ">
                                                            <ul>
                                                                <li><?php if($p_type=="pack" && $packType!="electricity" && $packType!="gas"): ?> <?php echo app('translator')->getFromJson('home.Gas'); ?> + <?php echo app('translator')->getFromJson('home.Electricity'); ?> <?php elseif($p_type=='gas' || $packType=="gas"): ?> <?php echo app('translator')->getFromJson('home.Gas'); ?> <?php elseif($p_type=='electricity' || $packType=="electricity"): ?> <?php echo app('translator')->getFromJson('home.Electricity'); ?> <?php else: ?> <?php endif; ?></li>
                                                                 <?php if((Session::get('promo')=='true' && $parameters['values']['promo_discount']['promo']=='promo') || (Session::get('domi')=='true' && $parameters['values']['promo_discount']['discount_serviceLevelPayment']=='domi') || (Session::get('email')=='true' && $parameters['values']['promo_discount']['discount_serviceLevelInvoicing']=='email')): ?>
                                                                <!--<li><?php echo app('translator')->getFromJson('home.Discounts'); ?></li>-->
                                                          <!--       <li>Welkomstkortingen</li>
                                                                <li>beperkte dienstverlening</li>
                                                  ...
                                                  <!--       <?php
                                                       ...
                                                       <!--  <div class="col-md-4 col-4 col-lg-4 energy-price second-red text-right">
                                                            <ul>
                                                                <li><b>&#8364; <?php echo e(number_format($price['totals']['year']['excl_promo']/100,2,',', '.')); ?></b></li>
                                                                   <?php if((Session::get('promo')=='true' && $parameters['values']['promo_discount']['promo']=='promo') || (Session::get('domi')=='true' && $parameters['values']['promo_discount']['discount_serviceLevelPayment']=='domi') || (Session::get('email')=='true' && $parameters['values']['promo_discount']['discount_serviceLevelInvoicing']=='email')): ?>
                                                                <li class="red-text"><b>- &#8364; <?php echo e(number_format($eleD+$gasD,2,',', '.')); ?></b></li>
                                                                <?php if($sl_disc>0): ?> <li class="red-text">- &#8364; <?php echo e(number_format($sl_disc,2,',', '.')); ?></li><?php endif; ?>
                                                                <?php if($loyalty_disc>0): ?><li class="red-text">- &#8364; <?php echo e(number_format($loyalty_disc,2,',', '.')); ?></li><br><?php endif; ?>
                                                                
                                                                <li><b>&#8364; <?php echo e(number_format(($price['totals']['year']['excl_promo']/100)-($eleD+$gasD+$all_disc),2,',', '.')); ?></b></li>
                                                                <?php else: ?>
                                                ...
                                                <div class="row net-sec net-sec-1 mt-1">
                                                    ...
                                                    <div class="col-md-6 col-4 energy-price text-right">
                                                        ...
                                                        <?php else: ?>
                                                           <?php if(isset($price['breakdown']['electricity']['unit_cost']['energy_cost'])): ?> <li><?php echo e(number_format(((($price['breakdown']['electricity']['energy_cost']['fixed_fee']/100)+($price['breakdown']['electricity']['energy_cost']['single']/100+$price['breakdown']['electricity']['energy_cost']['day']/100+$price['breakdown']['electricity']['energy_cost']['night']/100+$price['breakdown']['electricity']['energy_cost']['excl_night']/100)+($price['breakdown']['electricity']['energy_cost']['certificates']/100))/$totalElec)*100,2,',', '.')); ?> &#8364;c/kWh</li><?php endif; ?>
                                                        ...
                                                        <?php endif; ?>
                                                         ...
                                                         <?php else: ?>
                                                          ...
                                                          <?php if((Session::get('promo')=='true' && $parameters['values']['promo_discount']['promo']=='promo') || (Session::get('domi')=='true' && $parameters['values']['promo_discount']['discount_serviceLevelPayment']=='domi') || (Session::get('email')=='true' && $parameters['values']['promo_discount']['discount_serviceLevelInvoicing']=='email')): ?>
                                                            ...
                                                            <?php if($totalElec>0): ?>
                                                           <?php  $uPrice=(($price['breakdown']['electricity']['energy_cost']['fixed_fee']/100)+($price['breakdown']['electricity']['energy_cost']['single']/100+$price['breakdown']['electricity']['energy_cost']['day']/100+$price['breakdown']['electricity']['energy_cost']['night']/100+$price['breakdown']['electricity']['energy_cost']['excl_night']/100)+($price['breakdown']['electricity']['energy_cost']['certificates']/100)-($promo_discE))/$totalElec;   ?>
                                                            <?php else: ?>
                                                           <?php $uPrice=0; ?>
                                                            <?php endif; ?>
                                                        ...
                                                        <?php else: ?>
                                                            <?php if($totalElec>0): ?>
                                                           <?php  $uPrice=(($price['breakdown']['electricity']['energy_cost']['fixed_fee']/100)+($price['breakdown']['electricity']['energy_cost']['single']/100+$price['breakdown']['electricity']['energy_cost']['day']/100+$price['breakdown']['electricity']['energy_cost']['night']/100+$price['breakdown']['electricity']['energy_cost']['excl_night']/100)+($price['breakdown']['electricity']['energy_cost']['certificates']/100))/$totalElec;   ?>
                                                            <?php else: ?>
                                                           <?php $uPrice=0; ?>
                                                            <?php endif; ?>
                                                 ...
                                                 <div class="row elec-sec-1">
                                                    ...
                                                    <div class="row net-sec net-sec-1 mt-1">
                                                    <div class="col-md-12 col-8 energy">
                                                        <ul>
                                                        <?php if($product['type']=='pack'): ?> 
                                   ...
                                   <?php if($descs): ?><li class="product-desc-i"><?php echo $descs; ?></li><?php endif; ?>
                                       <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        ...
                                        <div class="row product-tab-btn">
                                            <div class="col-md-12 text-right">
                                        <form action="<?php echo e(url('bevestiging')); ?>" method="post">
                                        <?php echo e(csrf_field()); ?>
...
<!--                                                    <a class="more-info" href="#"><?php echo app('translator')->getFromJson('home.More_info'); ?></a>-->
                                                ...
                                                <div class="contract-for">
                                                    ...
                                                    <?php if($parameters['values']['customer_group'] == 'residential'): ?> 
...
?>
                                                        ...
                                                        <!--<p><?php echo e(str_replace($replace, $info, $string)); ?></p>-->
                                                ...
                                                <div class="documents">
                                                    ...
                                                    <ul>
                                                        <?php if($product['type']=='pack'): ?> 
                                                            <li><a href="<?php echo e($product['underlying_products']['electricity']['terms_url_dynamic']); ?>" target="_block"><img src="<?php echo e(url('images/pdf-image.png')); ?>" alt="Tariefchecker">&nbsp <?php echo app('translator')->getFromJson('home.Tariff_card_Electricity'); ?></a></li>
                                                            <li><a href="<?php echo e($product['underlying_products']['gas']['terms_url_dynamic']); ?>" target="_block"><img src="<?php echo e(url('images/pdf-image.png')); ?>" alt="Tariefchecker">&nbsp <?php echo app('translator')->getFromJson('home.Tariff_card_Gas'); ?></a></li>
                                                            <li><a href="<?php echo e($product['terms_url']); ?>" target="_block"><img src="<?php echo e(url('images/pdf-image.png')); ?>" alt="Tariefchecker">&nbsp <?php echo app('translator')->getFromJson('home.Tariff_card_General_conditions'); ?></a></li>
                                                        <?php elseif($product['type']=='electricity'): ?>
                                                            <li><a href="<?php echo e($product['terms_url_dynamic']); ?>" target="_block"><img src="<?php echo e(url('images/pdf-image.png')); ?>" alt="Tariefchecker">&nbsp <?php echo app('translator')->getFromJson('home.Tariff_card_Electricity'); ?></a></li>
                                                            <li><a href="<?php echo e($product['terms_url']); ?>" target="_block"><img src="<?php echo e(url('images/pdf-image.png')); ?> alt="Tariefchecker"">&nbsp <?php echo app('translator')->getFromJson('home.Tariff_card_General_conditions'); ?></a></li>
                                                        <?php elseif($product['type']=='gas'): ?>
                                                            <li><a href="<?php echo e($product['terms_url_dynamic']); ?>" target="_block"><img src="<?php echo e(url('images/pdf-image.png')); ?>" alt="Tariefchecker">&nbsp <?php echo app('translator')->getFromJson('home.Tariff_card_Gas'); ?></a></li>
                                                            <li><a href="<?php echo e($product['terms_url']); ?>" target="_block"><img src="<?php echo e(url('images/pdf-image.png')); ?>" alt="Tariefchecker">&nbsp <?php echo app('translator')->getFromJson('home.Tariff_card_General_conditions'); ?></a></li>
                                                        <?php else: ?>
                                                            <li><a href="<?php echo e($product['terms_url']); ?>" target="_block"><img src="<?php echo e(url('images/pdf-image.png')); ?>" alt="Tariefchecker">&nbsp <?php echo app('translator')->getFromJson('home.Tariff_card_General_conditions'); ?></a></li>
                                                        <?php endif; ?>
...
In de praktijk is het zelden zinvol om binnen het eerste jaar opnieuw te veranderen, maar als de vaste vergoeding volledig wordt aangerekend hou je daar best rekening mee. Meer info in onze
                  ...
                  <p>A1--Het is opnieuw tijd voor de kwartaalcheck van jouw energietarieven.</p>
                  ...
                  <p>A2--Het is opnieuw tijd voor de kwartaalcheck van jouw energietarieven.</p>
                  <p>De vraag: <b>zit je nog goed?</b></p>
                  <p>Het antwoord: <b>JA</b></p>
                  ...
                  <p>B1--Het is opnieuw tijd voor de kwartaalcheck van jouw energietarieven.</p>
                  <p>De vraag: <b>zit je nog goed?</b></p>
                  <p>Het antwoord: <b>JA</b></p>
                  ...
                  <p>B2--Het is opnieuw tijd voor de kwartaalcheck van jouw energietarieven.</p>
                  <p>De vraag: <b>zit je nog goed?</b></p>
                  ...
                  <p>Als je opnieuw overstapt worden je data in onze systemen voor de kwartaalcheck gereset, en anders gaan we gewoon door met je huidige voor de volgende kwartaalcheck.</p>
                            ...
                            <div class="row part-last">
                                <div class="col-md-6 compare">
                                    <input type="checkbox"  class="compare myCheck<?php echo e($product['id']); ?>" name="compare" value="<?php echo e($product['id']); ?>"> <?php echo app('translator')->getFromJson('home.Compare'); ?><br>
                                </div>
