                                        ...
                                        <tbody>
                                          ...
                                          <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $datas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            ...
                                            <tr>
                                                <td><?php echo e($i++); ?></td>
                                                <td>
                                                    <?php if($datas->page_name=="request page"): ?> Confirmation page 
                                                    <?php endif; ?>
                                                    <?php if($datas->page_name=="sort page"): ?> Comparison page 
                                                    <?php endif; ?>
                                                    <?php if($datas->page_name=="sort_page banner"): ?> Comparison page banner 
                                                    <?php endif; ?>
                                                    <?php if($datas->page_name=="sort_page last"): ?> Comparison page bottom title 
                                                    <?php endif; ?>
                                                </td>
                                                <td><?php echo e($datas->banner_content_in_english); ?></td>
                                                <td><?php if($datas->banner_image): ?><img src="/images/<?php echo e($datas->banner_image); ?>" width="100px"><?php endif; ?></td>
                                               
                                                
                                                <td>
                                                   
                                                    <a class="btn btn-sm btn-primary" href="<?php echo e(route('banner-content.index')); ?>/<?php echo e($datas->id); ?>/edit"><i class="fa fa-edit"></i> edit</a>
                                                </td>
