...
<!-- error message -->
                  ...
                  <div class="card-body">
                    <form id="form"  method="POST" action="<?php echo e(route('whitelabel.tacking_code_update')); ?>" enctype="multipart/form-data">
        ...
        <div class="form-group <?php echo e($errors->has('page') ? ' has-danger' : ''); ?>">
            ...
            <textarea type="text" name="google_analytics" id="page"  class="form-control" ><?php echo e($tracking->google_analytics); ?></textarea>
        ...
        <div class="form-group <?php echo e($errors->has('content_eng') ? ' has-danger' : ''); ?>">
            ...
            <textarea type="text" class="form-control" name="facebook_pixel" id="content_eng" ><?php echo e($tracking->facebook_pixel); ?></textarea>
        ...
        <div class="form-group <?php echo e($errors->has('content_eng') ? ' has-danger' : ''); ?>">
            ...
            <textarea type="text" class="form-control" name="other_tracking_code" id="content_eng" ><?php echo e($tracking->other_tracking_code); ?></textarea>
            <?php if($errors->has('content_eng')): ?>
            <div id="first_name-error" class="form-control-feedback text-danger"><?php echo e($errors->first('content_eng')); ?></div>
            <?php endif; ?>
        </div>
