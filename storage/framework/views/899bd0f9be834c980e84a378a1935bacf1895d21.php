                               ...
                               ?>
                                ...
                                <div class="col-md-2 col-sm-12 part-5">
                                    ...
                                    <form action="<?php echo e(url('bevestiging')); ?>" method="get">
                                        ...
                                        <button id="choose<?php echo e($product['id']); ?>" data-id="<?php echo e($product['id']); ?>" type="submit" class="choose" rel="tooltip" title="<?php echo app('translator')->getFromJson('home.choose_Kiezen'); ?>"><?php echo app('translator')->getFromJson('home.To_Request'); ?></button>
                                        <?php
            ...
            <div class="underline">
                <div class="card">
                    <div class="card-header" id="headingOne">
                        <h5 class="mb-0">
                            <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseOne<?php echo e($product['id']); ?>" aria-expanded="true">
                   ...
                   <?php
                    ...
                    <div id="collapseOne<?php echo e($product['id']); ?>" class="collapse" aria-labelledby="headingOne" data-parent="#accordion">
                        <div class="card-body">
                            <div id="" class="">
                                    ...
                                    <div class="col-md-4 col-lg-4 col-sm-12 total-sec">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12 mt-4 text-right" >
                                                      <form action="<?php echo e(url('bevestiging'.'/'.$supplier['name'].'/'.$product['name'])); ?>" method="post">
                                        <?php echo e(csrf_field()); ?>

                                        <input type="hidden" name="pri_save" class="pri_save<?php echo e($si); ?>">
                                        <input type="hidden" name="pro_id"  value="<?php echo e($product['id']); ?>">
                                        <input type="hidden" name="type"  value="<?php echo e($customer_type); ?>">
                                        <input type="hidden" name="postalcode"  value="<?php echo e($postal_code); ?>">
                                        <input type="hidden" name="elect_day" id="" <?php if(isset($usage_elec_day)): ?> value="<?php echo e($usage_elec_day); ?>" <?php endif; ?>>
                                        <input type="hidden" name="elect_night" <?php if(isset($usage_elec_night)): ?> value="<?php echo e($usage_elec_night); ?>" <?php endif; ?>>
                                        <input type="hidden" name="gas_cons" <?php if(isset($usage_gas)): ?> value="<?php echo e($usage_gas); ?>" <?php endif; ?>>
                                        <input type="hidden" name="sub_url"  value="<?php echo e($product['subscribe_url']); ?>">
...
?>
                                                ...
                                                <p><?php echo str_replace($replace, $info, $string); ?> <?php echo e(ucfirst(trans('home.Discounts'))); ?> <?php echo str_replace($replace1, $info1, $string1); ?></p>
                                            <?php if((Session::get('promo')=='true' && $parameters['values']['promo_discount']['promo']=='promo') || (Session::get('domi')=='true' && $parameters['values']['promo_discount']['discount_serviceLevelPayment']=='domi') || (Session::get('email')=='true' && $parameters['values']['promo_discount']['discount_serviceLevelInvoicing']=='email')): ?>
                                               
                                             <?php elseif(Session::get('promo')=='true' && $parameters['values']['promo_discount']['promo']=='false'): ?>       
            ...
            <div class="underline">
                <div class="card">
                    <div class="card-header" id="headingTwo">
                        <h5 class="mb-0">
                            <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseTwo<?php echo e($product['id']); ?>" aria-expanded="false">
                                <?php echo app('translator')->getFromJson('home.Discounts'); ?> <span class="arrow-down"><i class="fa fa-chevron-down"></i></i></span>
                            </button>
                        </h5>
                    </div>
                    <div id="collapseTwo<?php echo e($product['id']); ?>" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
                        <div class="head-p">
                                     <?php $ab=array();  ?>
    ...
    <?php endif; ?>
            ...
            <div class="underline">
                <div class="card">
                    <div class="card-header" id="headingThree">
                        <h5 class="mb-0">
                            <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseThree<?php echo e($product['id']); ?>" aria-expanded="false">
                                <?php echo app('translator')->getFromJson('home.Product_Description'); ?> <span class="arrow-down"><i class="fa fa-chevron-down"></i></i></span>
                            </button>
                        </h5>
                    </div>
                    <div id="collapseThree<?php echo e($product['id']); ?>" class="collapse" aria-labelledby="headingThree" data-parent="#accordion">
                        <div class="card-body">
        ...
        <div class="underline">
            <div class="card">
                <div class="card-header" id="headingThree">
                    <h5 class="mb-0">
                        <button class="btn btn-link collapsed" data-toggle="collapse" data-target="#collapseFour<?php echo e($product['id']); ?>" aria-expanded="false">
                           <?php echo app('translator')->getFromJson('home.Contract_Details'); ?> <span class="arrow-down"><i class="fa fa-chevron-down"></i></i></span>
                        </button>
                    </h5>
                </div>
                <div id="collapseFour<?php echo e($product['id']); ?>" class="collapse" aria-labelledby="headingThree" data-parent="#accordion">
                    <div class="card-body">
                        <div id="" class="">
                               <div class="row">
...
In de praktijk is het zelden zinvol om binnen het eerste jaar opnieuw te veranderen, maar als de vaste vergoeding volledig wordt aangerekend hou je daar best rekening mee. Meer info in onze
                                        ...
                                        <input type="hidden" name="type" id="get_type" value="<?php echo e($customer_type); ?>">
                                        <input type="hidden" name="postalcode" id="get_postalcode" value="<?php echo e($postal_code); ?>">
                                        <input type="hidden" name="elect_day" id="" <?php if(isset($usage_elec_day)): ?> value="<?php echo e($usage_elec_day); ?>" <?php endif; ?>>
                                        <input type="hidden" name="elect_night" <?php if(isset($usage_elec_night)): ?> value="<?php echo e($usage_elec_night); ?>" <?php endif; ?>>
                                        <input type="hidden" name="gas_cons" <?php if(isset($usage_gas)): ?> value="<?php echo e($usage_gas); ?>" <?php endif; ?>>
                                        <input type="hidden" name="sub_url" id="pro_id" value="<?php echo e($product['subscribe_url']); ?>">
                                        <button type="submit" class="choose1"><?php echo app('translator')->getFromJson('home.To_Request'); ?></button>
                                                          </form>
                                                </div>
                                            </div>
