    ...
    <div class="container">
        <div class="row">
			...
			<p><?php echo e(str_replace($replace2, $info2, $string2)); ?></p>
                    ...
                    <ul>
                        <li><a href="#"><?php echo app('translator')->getFromJson('home.Terms_conditions'); ?></a></li>
                        <li><a href="#"><?php echo app('translator')->getFromJson('home.Contact'); ?></a></li>
                        <li><a href="#"><?php echo app('translator')->getFromJson('home.Frequently_asked'); ?></a></li>
...
<style type="text/css">
    ...
    <?php if($more_tariffs_button_color): ?>
        .load-more-sec{
            color:<?php echo e($more_tariffs_button_color); ?>!important;  
        }
    <?php endif; ?>
    ...
    <?php if($active_tab_color): ?>
        .more-tab .btn-link:hover{
          color: <?php echo e($active_tab_color); ?>!important;
        }
    <?php endif; ?> 
    <?php if($link_color): ?>
      .more-content a{
           color:<?php echo e($link_color); ?>!important; 
      } 
    <?php endif; ?> 
    <?php if($discount_sum_color): ?>
      .red-text{
           color:<?php echo e($discount_sum_color); ?>!important; 
      } 
    <?php endif; ?> 
