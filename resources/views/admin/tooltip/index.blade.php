                        ...
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header ">
                                    <h3 class="card-title ">Manage Tooltip</h3>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover card-table table-striped table-vcenter table-outline text-nowrap">
                                        ...
                                        <tbody>
                                          @php $i=1; @endphp
                                          @foreach($tooltip as $tooltips)
                                           
                                            <tr>
                                                <td>{{$i++}}</td>
                                                <td>{{$tooltips->slug}}</td>
                                                <td>{{$tooltips->field_name}}</td>
                                                
                                                
                                                <td>
                                                   
                                                    <a class="btn btn-sm btn-primary" href="{{route('tooltip.index')}}/{{$tooltips->id}}/edit"><i class="fa fa-edit"></i> edit</a>
                                                </td>
