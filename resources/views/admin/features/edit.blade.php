...
<!-- error message -->
            ...
            <!-- ROW-2 OPEN -->
                <div class="card accordion-wizard">
                  ...
                  <div class="card-body">
                    <form id="form"  method="POST" action="{{route('feature.update',$feature->id)}}" enctype="multipart/form-data">
                      {{csrf_field()}}
                          ...
                          <div data-acc-content="" style="">
                            <div class="my-3">
                              <div class="form-group {{ $errors->has('part') ? ' has-danger' : '' }}">
                               ...
                               <input class="form-control" type="text" name="part" id="part" value="{{$feature->part}}" disabled="disabled" required>
                                    @if ($errors->has('part'))
                              ...
                              <div class="form-group {{ $errors->has('field') ? ' has-danger' : '' }}">
                                ...
                                <input class="form-control" type="text" name="field" id="field" value="{{$feature->field}}" disabled="disabled" required>
                                    @if ($errors->has('field'))
                               ...
                               <div class="form-group {{ $errors->has('condition') ? ' has-danger' : '' }}">
                                ...
                                <input class="form-control" type="text" name="condition" id="condition" value="{{$feature->condition}}" disabled="disabled" required>
                               ...
                               <div class="form-group {{ $errors->has('NL_description') ? ' has-danger' : '' }}">
                                <label>NL Description:</label>
                                 <textarea class="form-control" required="required"  id="summernotea" aria-describedby="Description" placeholder="Content" name="NL_description" required>{{$feature->NL_description}}</textarea>
                               ...
                               <div class="form-group {{ $errors->has('FR_description') ? ' has-danger' : '' }}">
                                <label>FR Description:</label>
                                  ...
                                  <textarea class="form-control" required="required"  id="summernotea" aria-describedby="Description" placeholder="Content" name="FR_description" rows="6" required>{{$feature->FR_description}}</textarea>
