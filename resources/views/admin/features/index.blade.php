...
<!-- error message -->
                                          ...
                                          @foreach($features as $feature)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a class="btn btn-sm btn-primary" href="{{route('feature.index')}}/{{$feature->id}}/edit"><i class="fa fa-edit"></i> edit</a>
                                                </td>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header ">
                                    <h3 class="card-title ">Service Limitations</h3>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-hover card-table table-striped table-vcenter table-outline text-nowrap">
                                        <thead>
                                            <tr>
                                            <th scope="col">ID</th>
                                            <th scope="col">Service level Payment</th>
                                            <th scope="col">Service level Invoice</th>
                                            <th scope="col">Service level contact</th>
                                            <th scope="col">NL description</th>
                                            <th scope="col">FR description</th>
                                            <th scope="col"></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                          @php $i=1; @endphp
                                          @foreach($servicelimitation as $servicelimitations)
                                           
                                            <tr>
                                                <td>{{$i++}}</td>
                                                <td>{{$servicelimitations->SL_payment}}</td>
                                                <td>{{$servicelimitations->SL_invoice}}</td>
                                                <td>{{$servicelimitations->SL_contact}}</td>
                                                <td>{{$servicelimitations->NL_description}}</td>
                                                <td>{{$servicelimitations->FR_description}}</td>
                                                <td>
                                                    
                                                    <a class="btn btn-sm btn-primary" href="{{route('feature.index')}}/{{$servicelimitations->id}}"><i class="fa fa-edit"></i> edit</a>
                                                </td>
