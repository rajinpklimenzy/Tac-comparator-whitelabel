...
<!-- error message -->
                  ...
                  <div class="card-body">
                    <form id="form"  method="POST" action="{{route('banner-content.update',$banner->id)}}" enctype="multipart/form-data">
                      {{csrf_field()}}
                          ...
                          <div data-acc-content="" style="">
                            <div class="my-3">
                              <div class="form-group {{ $errors->has('page') ? ' has-danger' : '' }}">
                                ...
                                <input type="text" data-toggle="tooltip" title="Page name" name="page" id="page" value="@if($banner->page_name=="request page") Confirmation page 
                                                    @endif
                                                    @if($banner->page_name=="sort page") Comparison page 
                                                    @endif
                                                    @if($banner->page_name=="sort_page banner") Comparison page banner 
                                                    @endif
                                                    @if($banner->page_name=="sort_page last") Comparison page bottom title 
                              ...
                              <div class="form-group {{ $errors->has('content_eng') ? ' has-danger' : '' }}">
                                ...
                                <input type="text" data-toggle="tooltip" title="Heading in english" class="form-control" name="content_eng" id="content_eng" value="{{$banner->banner_content_in_english}}" required>
                               ...
                               <div class="form-group {{ $errors->has('content_nl') ? ' has-danger' : '' }}">
                                <label>Heading in NL: @if($banner->page_name=='sort page')<span style="color:green;">X1:Comparison type (eg: gas/electricity/gas and electricity) , X2:Month , X3:Year</span>    @endif</label>
                                <input type="text" class="form-control" data-toggle="tooltip" title="Banner content in nl" name="content_nl" id="content_nl" value="{{$banner->banner_content_in_NL}}" required>
                               ...
                               <div class="form-group {{ $errors->has('content_fr') ? ' has-danger' : '' }}">
                                <label>Heading in FR: @if($banner->page_name=='sort page')<span style="color:green;">X1:Comparison type (eg: gas/electricity/gas and electricity) , X2:Month , X3:Year</span>    @endif</label>
                                <input class="form-control" type="text" data-toggle="tooltip" title="Heading in fr"  aria-describedby="Description" name="content_fr" id="content_fr" value="{{$banner->banner_content_in_FR}}" required>
                              ...
                              @if($banner->banner_image)
                               <div class="form-group {{ $errors->has('banner_image') ? ' has-danger' : '' }}">
                                 ...
                                 @if($banner->page_name=='request page')
                              ...
                              <div class="col-3">
                                  <input class="form-control" type="file" data-toggle="tooltip" title="Banner image" name="banner_image" id="banner_image" value="{{$banner->banner_image}}" >
