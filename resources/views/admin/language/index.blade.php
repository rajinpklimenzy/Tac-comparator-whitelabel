                                    ...
                                    <table class="table table-hover card-table table-striped table-vcenter table-outline text-nowrap">
                                        <thead>
                                            <tr>
                                                ...
                                                <th scope="col">Content in English</th>
                                                <!-- <th scope="col">Content in Dutch</th>
                                                <th scope="col">Content in French</th> -->
                                                <th scope="col"></th>
                                        ...
                                        <tbody>
                                          ...
                                          @foreach($language as $languages)
                                            ...
                                            <tr>
                                                <td>{{$i++}}</td>
                                                <td>{{$languages->page}}</td>
                                                <td>{{substr($languages->eng,0,60)}}</td>
                                                <!-- <td>{{$languages->nl}}</td>
                                                <td>{{$languages->fr}}</td> -->
                                                ...
                                                <td>
                                                    ...
                                                    <a class="btn btn-sm btn-primary" href="{{route('language.index')}}/{{$languages->id}}/edit"><i class="fa fa-edit"></i> edit</a>
                                                </td>
