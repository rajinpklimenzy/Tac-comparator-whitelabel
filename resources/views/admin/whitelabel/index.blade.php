...
<body class="app sidebar-mini">
    ...
    @include('admin.includes.sidebar')
                                         ...
                                         {{csrf_field()}}
                                            ...
                                            @foreach($whitelabel as $whitelabels)
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>@if($whitelabels->logo)
                                                                            <img src="/uploads/logos/{{$whitelabels->logo}}" width="100px">@endif
                                                                            </td>
                                                                            <td>{{date('d-m-Y', strtotime($whitelabels->created_at))}}</td>
                                                                            <td>
                                                    @if($whitelabels->activate==1)
                                                  
                                                                                <a class="btn btn-sm btn-success" href="{{url('whitelabel/activate/'.$whitelabels->id)}}">
                                                                                    <i class="fa fa-edit"></i> Active
                                                                                </a>
                                                  @else
                                                   
                                                                                <a class="btn btn-sm btn-danger" href="{{url('whitelabel/activate/'.$whitelabels->id)}}">
                                                                                    <i class="fa fa-edit"></i> Deactive
                                                                                </a>

                                                  @endif
                                                    
                                                                                <a class="btn btn-sm btn-danger"  data-toggle="modal" data-target="#myModal{{$whitelabels->id}}">
                                                                                    <i class="fa fa-trash"></i> Delete
                                                                                </a>
                                                                            </td>
                                                                        </tr>
                                                                        <!-- The Modal -->
                                                                        <div class="modal" id="myModal{{$whitelabels->id}}">
        ...
        Are you sure you want to delete ?
                                                                                    ...
                                                                                    <!-- Modal footer -->
                                                                                    <div class="modal-footer">
                                                                                        <a href="{{url('whitelabel/delete/'.$whitelabels->id.'/'.$whitelabels->email)}}" class="btn btn-success" >Yes</a>
