...
<!--                                        <ul>
                                    ...
                                    <div class="bottom-texts">
                                        ...
                                        <ul class="bottom-box-list">
                                            ...
                                            <li class="right right-dis"><strong>-&#8364; {{number_format(($product['price']['totals']['year']['excl_promo']/100)-(float)$prc,2,',', '.')}}</strong></li>
                                        </ul>
                                        @endif
                                        <div class="clear"></div>
                                        <hr class="line-under">
                                        ...
                                        <ul class="bottom-box-list">
                                            ...
                                            <li class="right"><strong>&#8364; {{number_format((float)$prc,2,',', '.')}}</strong></li>
                                            @else
                                            <li class="right"><strong>&#8364; {{number_format($product['price']['totals']['year']['excl_promo']/100,2,',', '.')}}</strong></li>
                                            @endif
                                        </ul>
                                        <ul class="bottom-box-list">
                                            ...
                                            <li class="right"><strong>&#8364; {{number_format(((float)$prc)/12,2,',', '.')}}</strong></li>
                                            @else
...
Uw aanvraag is ingediend 
                                    ...
                                    <div class="col-md-7 col-sm-7 thumps-up-icon">
                                       <img src="/images/landing-page-image/{{$man->mascot_image}}">
                                    </div>
                                </div>
                            </div>
...
Uw aanvraag is ingediend 
            ...
            @endphp
                                                       ...
                                                       <span class="cost2"> @lang('home.All_in_costs_Year') </span><br>
                                                        <h5 class="cost2  cost2-bold">&#8364; @php $prc1=number_format((float)$prc,2,',', '.');  $sp_price=preg_split("/,/",$prc1)  @endphp {{$sp_price[0]}}</b><sup>,{{$sp_price[1]}}</sup></h5>
                                                    @else
                                                        <span class="cost2 cost4"> @lang('home.All_in_costs_Year') </span><br>
                                                        <h5 class="cost3  cost2-bold">&#8364; @php $prc=number_format($product['price']['totals']['year']['excl_promo']/100,2,',', '.');  $sp_price=preg_split("/,/",$prc)  @endphp {{$sp_price[0]}}</b><sup>,{{$sp_price[1]}}</sup></h5>
                                                    @endif
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="row Box1">
                            ...
                            <div class="col-md-4 col-sm-4">
                               @if(isset($subcontent[0]['FR_title']))
                                <div class="right-box01">
                                    <h3>@if(isset($subcontent[0]['FR_title'])) @if(Session::get('locale')=='fr'){!!$subcontent[0]['FR_title']!!} @else (Session::get('locale')=='nl'){!!$subcontent[0]['NL_title']!!}@endif @endif</h3>
                            ...
                            <div class="col-md-8 col-sm-4">
                                <div class="left-contents">
                                   ...
                                   <a href="@if(isset($videocontent[0]['image_url'])) {{$videocontent[0]['image_url']}} @endif" target="_blank"> @if(isset($videocontent[0]['video'])) <img src="{{url('images/request-page/'.$videocontent[0]['video'])}}" alt="Dimitri"> @endif</a>
                                  
                                    <div class="bottom-content">
                                       @if(isset($videocontent[0]['FR_title'])) <h3>@if(Session::get('locale')=='fr'){!!$videocontent[0]['FR_title']!!} @else (Session::get('locale')=='nl'){!!$videocontent[0]['NL_title']!!} @endif</h3> @endif
                                       @if(isset($videocontent[0]['FR_content'])) <p>@if(Session::get('locale')=='fr'){!!$videocontent[0]['FR_content']!!} @else (Session::get('locale')=='nl'){!!$videocontent[0]['NL_content']!!} @endif<br>
                                        </p> @endif
