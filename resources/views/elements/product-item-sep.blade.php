                                    ...
                                    <ul>
                                       ...
                                       <li>
                                        ...
                                        @if(Session::get('locale')=='nl') 
                                            @if($product['contract_duration']=='123') @lang('home.123year')@elseif($product['contract_duration']=='13') @lang('home.13year')@elseif($product['contract_duration']=='0') @lang('home.Undetermined')@else {{$product['contract_duration']}} @lang('home.Year')@endif,
                                   ...
                                   @if($descs)<li class="product-desc-i">@php echo $descs; @endphp</li>@endif
                                       @endforeach
                                        ...
                                        <div class="row product-tab-btn">
                                            <div class="col-md-12 text-right">
                                        <form action="{{url('bevestiging')}}" method="post">
                                        {{csrf_field()}}
                                        <input type="hidden" name="pri_save" class="pri_save{{$si}}">
                                        <input type="hidden" name="pro_id"  value="{{$product['id']}}">
                                        <input type="hidden" name="supplier"  value="{{$supplier['name']}}">
