...
class CreateTenant extends Command
{
     ...
     * @var string
     */
    protected $signature = 'tenant:create {subdomain} {name} {email} {password} {logo}';
     ...
     * @var string
     */
    protected $description = 'Creates a Tenant with a subdomain, name and email. Example: php artisan tenant:create test "Test User" #ob#grfg#at#rknzcyr.pbz#ob#';
    ...
    {        
       ...
       // $fqdn = "{$subdomain}.{$url_base}";
        ...
        $hostname = $this->createTenant( $fqdn ,$name,$email ,$logo);
    ...
    private function createTenant( $fqdn ,$name ,$email ,$logo)
    {
