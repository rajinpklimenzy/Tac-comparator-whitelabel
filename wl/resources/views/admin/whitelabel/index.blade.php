	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
                <form action="{{ route('whitelabel.create')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="form-group">
						...
						<span id="succ" style="color: green; display: none;"><b>Password confirmed</b></span>
						<span id="error" style="color: red; display: none;"><b>Password mismatch</b></span>
                    </div>
                    
					<div class="form-group">
						<label for="image" class="form-control-label">Logo image</label>
						<input type="file" name="logo" required class="form-control" id="image">
					</div>
                            ...
                            <div class="card">
                                <div class="card-header ">
                                    ...
                                    <div class="card-options">
                                        <button id="add__new__list" type="button" class="btn btn-md btn-primary " data-toggle="modal" data-target="#exampleModal3"><i class="fa fa-plus"></i> Add a Whitelabel app</button>
                                    </div>
                                </div>
                                <div class="table-responsive">
                                    <table class="table table-hover card-table table-striped table-vcenter table-outline text-nowrap">
                                        ...
                                        <tbody>
                                        	@php $i=1; @endphp
                                        	@foreach($whitelabel as $whitelabels)
                                           
                                            <tr>
                                                <td>{{$i++}}</td>
                                                <td>{{$whitelabels->fqdn}}</td>
                                                <td>{{$whitelabels->name}}</td>
                                                <td>{{$whitelabels->email}}</td>
                                                <td>@if($whitelabels->logo)<img src="/uploads/logos/{{$whitelabels->logo}}" width="100px">@endif</td>
                                                <td>{{$whitelabels->created_at}}</td>
                                                
                                                <td>
                                                   <!--  <a class="btn btn-sm btn-primary" href="#"><i class="fa fa-edit"></i> Edit</a>  -->
                                                    <a class="btn btn-sm btn-danger" href="{{url('whitelabel/delete/'.$whitelabels->id.'/'.$whitelabels->website_id)}}"><i class="fa fa-trash"></i> Delete</a>
                                                </td>
            ...
            <div class="container">
                <div class="row align-items-center flex-row-reverse">
                    <div class="col-md-12 col-sm-12 text-center">
                        Copyright © 2019 <a href="#">{{Request::getHost()}}</a> All rights reserved.
                    </div>
                </div>
            </div>
        </footer>
